                ...
                while (true && !isFinishing()) {
                    while (FacePassHandler.isAvailable()) {
                        ...
                        try {
                            ...
                            config.livenessModel = FacePassModel.initModel(getApplicationContext().getAssets(), "liveness.3288CPU.rgb.int8.C.bin");
                            ...
                            config.landmarkModel = FacePassModel.initModel(getApplicationContext().getAssets(), "pf.lmk.float32.1015.bin");
